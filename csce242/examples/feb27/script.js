class Dog {
    ...
    get item() {
        ...
        moreSection.append(this.paragragh("Breed",this.breed));
        moreSection.append(this.paragragh("Color",this.color));
        moreSection.append(this.paragragh("Age",this.age));
    ...
    expandContract(e){
        const section = e.currentTarget.closest("section.dog").querySelector(".more");
